...
def deal_dealer():
    ...
    card_value = deal_card(dealer_card_frame)
    if card_value[0] == 1 and not dealer_ace:
        card_value = (11,card_value[1])
        dealer_ace = True
    dealer_score += card_value[0]
...
def deal_player():
    ...
    if card_value[0] == 1 and not player_ace:
        card_value = (11, card_value[1])
        player_ace = True
    player_score += card_value[0]
